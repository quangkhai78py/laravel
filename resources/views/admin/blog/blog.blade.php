...
@section('content')
        ...
        <form style="width: 50%;margin-left: 300px;" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input style="width: 100%;display: inline-block; margin-bottom: 20px;" type="text" class="form-control" id="email" name="name">
            ...
            <textarea class="ckeditor" name="content" style="width: 100%;display: inline-block; height: 200px;"></textarea>
