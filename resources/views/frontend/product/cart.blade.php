...
@section('content')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $.ajaxSetup({
                headers: {
                        'X-CSRF-TOKEN': $('meta[name="ain-token"]').attr('content')
                }
            });
            ...
            $('button#buyProduct').click(function(e){
                ...
                if (checkUser !== '') {
                    ...
                    if (name == '' && phone == '' && address == '' && avatar == '' && country == '' && email == '' && password == '') {
                        alert('bạn vui lòng đăng nhập nếu chưa có tài khoản!.. thì bạn có thể vui lòng nhập những thông tin trên để đăng kí thành viên');
                    }else{
                        if (name !== '') {
                            var name = $('#name').val();
                        }else{
