			...
			<div style="width: 100%;display: inline-block;">
				<div style="margin:20px 20px;">
					...
					<div>				
						...
						?>
						@foreach($cart as $valueProduct)
							<?php
								$avatar = json_decode($valueProduct['image'], true);
							?>	
							<tbody>							    
						    	<td style="border: 1px solid #ddd; padding: 8px;"><img src="{{$message->embed('upload/product/'.$user_id.'/'.$avatar['0']) }}"style="width:80px;" /></td>						    
						    	...
						    	?>					   
						    	<td style="border: 1px solid #ddd; padding: 8px;">$ {{$priceProduct}}</td>
						    	<?php
